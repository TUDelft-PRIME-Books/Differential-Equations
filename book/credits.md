...
> W.M. Schouten-Straatman from Delft University of Technology (2025) _`Differential equations`_. `https://tudelft-prime-books.github.io/Differential-Equations/`. Source files at `https://github.com/TUDelft-PRIME-Books/Differential-Equations`. CC BY 4.0.

You can refer to individual chapters or pages within this book as:

> `<Title of Chapter or Page>`. In W.M. Schouten-Straatman from Delft University of Technology (2025) _`Differential equations`_. `https://tudelft-prime-books.github.io/Differential-Equations/`. Source files at `https://github.com/TUDelft-PRIME-Books/Differential-Equations`. CC BY 4.0.
...
This website is written in markdown and jupyter notebooks files, which are converted to html using tools from [TeachBooks](https://teachbooks.io/). The files are stored on a [public GitHub repository](`https://github.com/TUDelft-PRIME-Books/Differential-Equations`). The website can be viewed at `https://tudelft-prime-books.github.io/Differential-Equations/`.
